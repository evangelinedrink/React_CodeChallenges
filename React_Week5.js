...
//Class Components are capitalized
  ...
  constructor(props) {
    ...
    this.setTextInputRef = inputElement => {
      ...
      switch(inputElement.id) {
        ...
        case "color": this.inputColor= inputElement; break; //When uses adds a new instructor, the color will be changed
      }
    }; 
